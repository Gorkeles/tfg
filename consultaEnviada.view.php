...
<head>
    ...
    <title>Enmascarados | Consulta Enviada</title>
...
<body>
    ...
    <div class="container">
            <header>
                <div class="image">
                    <img src="img/consulta.jpg" height="600px" alt="Consulta enviada"/>
                </div>
            </header>
            <main><br>
                <h1>¡ENHORABUENA!</h1><br>
                <h2>Tu consulta se ha enviado con éxito</h2>
                <h3>¡En breves le daremos una respuesta!</h3>
                <br><br><br><br><br><br>
